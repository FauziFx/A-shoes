            ...
            <div class="card-body">
              <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="col-md-10">
                    <select name="category" id="" class="custom-select" autofocus="" required>
                      ...
                      <?php foreach ($category as $cat):?>
                        <?php if($cat->categoryid == $products->category_id): ?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                    <input class="form-control" type="text" name="product_name" placeholder="Product Name" required value="<?=$products->product_name?>">
                  </div>
                  <div class="invalid-feedback">
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-md-10">
                    ...
                    <input type="number" class="form-control" name="price" placeholder="Price" required value="<?=$products->price?>">
                  </div>
                  <div class="invalid-feedback">
                    <?=form_error('price')?>  
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-md-2 mb-3">
                    ...
                    <input type="number" class="form-control" name="eur_38" placeholder="0" min="0" max="500" required value="<?=$products->eur_38?>">
                  </div>
                  <div class="input-group col-md-2 mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text">39</span>
                    </div>
                    <input type="number" class="form-control" name="eur_39" placeholder="0" min="0" max="500" required value="<?=$products->eur_39?>">
                  </div>
                  <div class="input-group col-md-2 mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text">40</span>
                    </div>
                    <input type="number" class="form-control" name="eur_40" placeholder="0" min="0" max="500" required value="<?=$products->eur_40?>">
                  </div>
                  <div class="input-group col-md-2 mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text">41</span>
                    </div>
                    <input type="number" class="form-control" name="eur_41" placeholder="0" min="0" max="500" required value="<?=$products->eur_41?>">
                  </div>
                  <div class="input-group col-md-2 mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text">42</span>
                    </div>
                    <input type="number" class="form-control" name="eur_42" placeholder="0" min="0" max="500" required value="<?=$products->eur_42?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-md-2 mb-3">
                    ...
                    <input type="number" class="form-control" name="eur_43" placeholder="0" min="0" max="500" required value="<?=$products->eur_43?>">
                  </div>
                  <div class="input-group col-md-2 mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text">44</span>
                    </div>
                    <input type="number" class="form-control" name="eur_44" placeholder="0" min="0" max="500" required value="<?=$products->eur_44?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                    <textarea name="description" class="form-control" id="" cols="30" rows="6" placeholder="Description" required=""><?=$products->description?></textarea>
                  </div>
                  <div class="invalid-feedback">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-10 form-inline form-row">
                    <div class="col-md-6">
                      <input type="file" class="form-control-file mb-2" name="files[]" multiple="">
                    </div>
                  </div>
                </div>

                <input type="hidden" name="productid" value="<?=$products->productid?>">
                <input type="hidden" name="productimageid" value="<?=$products->productimageid?>">
                <input type="hidden" name="sizeid" value="<?=$products->sizeid?>">
